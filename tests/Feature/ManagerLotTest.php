...
it('updates manual appointment targets without changing satisfaction targets', function () {
    ...
    $this->actingAs($manager)
        ...
        ->assertSee('1/3 physique (50%)')
        ->assertSee('1/2 contact (25%)')
        ...
        ->assertSee('--answered:50', false)
        ->assertDontSee('1/2 physique (50%)')
        ->assertDontSee('1/1 contact (25%)')
...
it('creates a Global Plus demand from a placed physical lot appointment with documents', function () {
    ...
    Http::fake(function ($request) {
        return match ($request->url()) {
            ...
            'https://global-plus.test/api/Intervention/ByDemande/5637' => Http::response([
