...
return [
    'definitions' => [
        ...
        'services.global_plus.api_url' => [
            'group' => 'API',
            'label' => 'Global+ API URL',
            'type' => 'string',
            'env' => 'GLOBAL_PLUS_API_URL',
            'fallback' => 'https://cee-api.test.globalplus.fr',
            'config' => 'services.global_plus.api_url',
            'rules' => ['nullable', 'url', 'max:500'],
            'description' => 'URL racine de l’API Global+.',
        ],
        'services.global_plus.api_key' => [
            'group' => 'API',
            'label' => 'Global+ API key',
            'type' => 'password',
            'env' => 'GLOBAL_PLUS_API_KEY',
            'config' => 'services.global_plus.api_key',
            'rules' => ['nullable', 'string', 'max:1000'],
            'secret' => true,
            'description' => 'Clé API Global+ utilisée pour obtenir le token Bearer.',
        ],
        'services.global_plus.bureau_id' => [
            'group' => 'API',
            'label' => 'Global+ bureau ID',
            'type' => 'integer',
            'env' => 'GLOBAL_PLUS_BUREAU_ID',
            'fallback' => 1035,
            'config' => 'services.global_plus.bureau_id',
            'rules' => ['nullable', 'integer', 'min:1'],
            'description' => 'Identifiant du bureau d’inspection Global+ à utiliser lors de la création des dossiers.',
        ],
        'services.global_plus.timeout' => [
            'group' => 'API',
            'label' => 'Global+ timeout',
            'type' => 'integer',
            'env' => 'GLOBAL_PLUS_API_TIMEOUT',
            'fallback' => 45,
            'config' => 'services.global_plus.timeout',
            'rules' => ['nullable', 'integer', 'min:5', 'max:300'],
            'description' => 'Timeout HTTP Global+ hors upload, en secondes.',
        ],
        'services.global_plus.upload_timeout' => [
            'group' => 'API',
            'label' => 'Global+ upload timeout',
            'type' => 'integer',
            'env' => 'GLOBAL_PLUS_API_UPLOAD_TIMEOUT',
            'fallback' => 90,
            'config' => 'services.global_plus.upload_timeout',
            'rules' => ['nullable', 'integer', 'min:10', 'max:600'],
            'description' => 'Timeout HTTP Global+ pour les envois de documents, en secondes.',
        ],
        'services.global_plus.connect_timeout' => [
            'group' => 'API',
            'label' => 'Global+ connect timeout',
            'type' => 'integer',
            'env' => 'GLOBAL_PLUS_API_CONNECT_TIMEOUT',
            'fallback' => 5,
            'config' => 'services.global_plus.connect_timeout',
            'rules' => ['nullable', 'integer', 'min:1', 'max:60'],
            'description' => 'Timeout de connexion à Global+, en secondes.',
        ],
    ],
];
