        ...
        <section class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
            @forelse ($lots as $lot)
                @php
                    ...
                    $lotCardCharts = $satisfactionCharts;

                    if ($lot['is_hybrid'] && is_array($dissatisfactionChart)) {
                        $lotCardCharts = $lotCardCharts->push($dissatisfactionChart);
                    }
