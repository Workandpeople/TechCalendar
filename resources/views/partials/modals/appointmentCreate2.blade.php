<div class="modal fade" id="appointmentCreateModal2" tabindex="-1" aria-labelledby="appointmentCreateModal2Label" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="appointmentCreateModal2Label">Créer un rendez-vous</h5>
