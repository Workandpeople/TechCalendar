...
class ManageUserController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'default_start_at' => 'nullable|regex:/^\d{2}:\d{2}(:\d{2})?$/',
                'default_end_at' => 'nullable|regex:/^\d{2}:\d{2}(:\d{2})?$/',
            ...
            return redirect()->back()->withErrors('Erreur lors de la création de l\'utilisateur.');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return redirect()->back()->withErrors('Erreur lors de la mise à jour de l\'utilisateur.');
        }
    }
