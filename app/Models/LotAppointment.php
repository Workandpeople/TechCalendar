...
#[Fillable([
    ...
    'global_plus_demand_id',
    'global_plus_intervention_id',
    'global_plus_status',
    'global_plus_payload',
    'global_plus_created_at',
    'global_plus_synced_at',
...
class LotAppointment extends Model
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'global_plus_payload' => 'array',
            'global_plus_created_at' => 'datetime',
            'global_plus_synced_at' => 'datetime',
